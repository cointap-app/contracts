...
contract ReflationTokenAutoLP is Context, IERC20, Ownable {
    ...
    constructor (
      ...
      address serviceAddr_
        ...
        _taxFee = txFee_; // % shares holders
        _liquidityFee = lpFee_; // %  add liquidity
        _previousLiquidityFee = lpFee_;

        _maxTxAmount = (_tTotal * 5 / 1000) * 10 ** _decimals;
        _numTokensSellToAddToLiquidity = (_tTotal * 5 / 10000) * 10 ** _decimals;
        ...
        _isExcludedFromFee[ownerAddr_] = true;
    ...
    function setNumTokenSellToAddLiquidity(uint256 newTokensSellToAddToLiquidity) public onlyOwner {
        _numTokensSellToAddToLiquidity = newTokensSellToAddToLiquidity;
    }
    ...
    function _handleTakeFee(uint256 tFee, uint256 rFee, uint256 tLiquidity, uint256 tDev) private {
        if(tFee > 0 || rFee > 0) {
    ...
    function _transferStandard(address sender, address recipient, uint256 tAmount) private {
        ...
        _handleTakeFee(tFee, rFee, tLiquidity, tDev);
